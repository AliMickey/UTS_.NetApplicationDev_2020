...
namespace Week4LabProgramQuestion
{
    class ArrayDB
    {
        ...
        public void getUserData()
        {
            ...
            {
                Console.Write("Enter the element " + loopVar + ":");
                string userinput = Console.ReadLine();
    ...
    class ArrayOperationsTest
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The Mean is " + newDB.CalculateMean());
            Console.WriteLine("The Variance is " + newDB.CalculateVariance());
            Console.WriteLine("The Standard Deviation is " + newDB.CalculateSD());
